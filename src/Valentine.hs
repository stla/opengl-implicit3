...
voxel1 :: Voxel
{-# NOINLINE voxel1 #-}
voxel1 = unsafePerformIO $ makeVoxel f1
                           ((-0.7,0.7),(-0.7,0.8),(-0.7,0.7))
                           (100, 100, 100)
voxmax1 :: Double
{-# NOINLINE voxmax1 #-}
voxmax1 = unsafePerformIO $ voxelMax voxel1

voxel2 :: Voxel
{-# NOINLINE voxel2 #-}
voxel2 = unsafePerformIO $ makeVoxel f2
                           ((-1.2,1.2),(-1.0,2.0),(-0.2,0.2))
                           (150, 200, 100)
voxmax2 :: Double
{-# NOINLINE voxmax2 #-}
voxmax2 = unsafePerformIO $ voxelMax voxel2
